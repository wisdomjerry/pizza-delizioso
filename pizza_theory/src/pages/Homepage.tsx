...
const HomePage = () => {
  ...
  const pizzaItems = [{
    ...
    price: '$18.99',
    image: 'https://images.unsplash.com/photo-1604382355076-af4b0eb60143?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80'
  }];
  const testimonials = [{
    id: 1,
    name: 'Sarah Johnson',
    quote: "The best pizza I've had in years! The crust is perfectly crispy and the toppings are always fresh.",
    rating: 5,
    image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80'
  }, {
    id: 2,
    name: 'Michael Rodriguez',
    quote: "Pizza Delizioso has become our family's Friday night tradition. Great food and excellent service!",
    rating: 5,
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80'
  }, {
    id: 3,
    name: 'Emily Chen',
    quote: "I'm very picky about my pizza, but this place never disappoints. Their Margherita pizza is to die for!",
    rating: 4,
  ...
  return <>
      ...
      <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        opacity: heroOpacity
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 z-10" style={{
          mixBlendMode: 'multiply'
        }} />
          <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Delicious pizza" className="w-full h-full object-cover" />
        </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          staggerChildren: 0.2
            ...
            <motion.div variants={fadeInVariants} transition={{
            duration: 0.5
      ...
      <section className="py-20 bg-stone-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pizzaItems.map((pizza, index) => <motion.div key={pizza.id} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            y: -10
                ...
                <div className="h-48 overflow-hidden">
                  <img src={pizza.image} alt={pizza.name} className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
                </div>
                <div className="p-6">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            duration: 0.6
              ...
              <img src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="Pizza chef preparing pizza" className="w-full h-full object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex text-yellow-400">
                      {[...Array(testimonial.rating)].map((_, i) => <StarIcon key={i} size={16} fill="currentColor" />)}
                      {[...Array(5 - testimonial.rating)].map((_, i) => <StarIcon key={i + testimonial.rating} size={16} />)}
                    </div>
                  </div>
                </div>
